    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back_arrow.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( FilActivity.this, MainActivity3.class);
        ...
        first_btn.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( FilActivity.this, Quarter1.class);
                startActivity(intent);
            }
        } );
        ...
        second_btn.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( FilActivity.this, Quarter2.class);
                startActivity(intent);
            }
        } );
        ...
        third_btn.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( FilActivity.this, Quarter3.class);
                startActivity(intent);
            }
        } );
