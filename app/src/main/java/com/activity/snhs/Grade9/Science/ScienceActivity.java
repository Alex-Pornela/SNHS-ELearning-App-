package com.activity.snhs.Grade9.Science;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back_arrow.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( ScienceActivity.this, MainActivity3.class);
        ...
        first_btn.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( ScienceActivity.this, Quarter1.class);
                startActivity(intent);
            }
        } );
        ...
        second_btn.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( ScienceActivity.this, Quarter2.class);
                startActivity(intent);
            }
        } );
        ...
        third_btn.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( ScienceActivity.this, Quarter3.class);
                startActivity(intent);
            }
        } );
        ...
        fourth_btn.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( ScienceActivity.this, Quarter4.class);
                startActivity(intent);
            }
        } );
        ...
        next_btn.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( ScienceActivity.this, FilActivity.class);
                startActivity(intent);
            }
        } );
    }
