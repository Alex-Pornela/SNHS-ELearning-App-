    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        back_arrow.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( EnglishActivity.this, MainActivity3.class);
        ...
        first_btn.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( EnglishActivity.this, Quarter1.class);
                startActivity(intent);
            }
        } );
        ...
        second_btn.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( EnglishActivity.this, Quarter2.class);
                startActivity(intent);
            }
        } );
        ...
        third_btn.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( EnglishActivity.this, Quarter3.class);
                startActivity(intent);
            }
        } );
        ...
        fourth_btn.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( EnglishActivity.this, Quarter4.class);
                startActivity(intent);
            }
        } );
