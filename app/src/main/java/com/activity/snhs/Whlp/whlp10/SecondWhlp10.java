package com.activity.snhs.Whlp.whlp10;
...
import com.activity.snhs.Whlp.grade10;
import com.activity.snhs.Whlp.whlp10.Quarter.Second;


public class SecondWhlp10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_second_whlp10 );
        ...
        first_btn.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent( SecondWhlp10.this, Second.class);
        ...
        back_arrow.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( SecondWhlp10.this, grade10.class);
                startActivity(intent);
                finish();
            }
        } );
