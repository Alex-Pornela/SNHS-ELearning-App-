...
import com.activity.snhs.Whlp.whlp7.Quarter.Second;

public class SecondWhlp7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_second_whlp7 );
        ...
        first_btn.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent( SecondWhlp7.this, Second.class);
        ...
        back_arrow.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( SecondWhlp7.this, grade7.class);
                startActivity(intent);
                finish();
            }
        } );
