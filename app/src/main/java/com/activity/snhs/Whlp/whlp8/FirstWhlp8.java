...
import com.activity.snhs.Whlp.whlp8.Quarter.First;


public class FirstWhlp8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_first_whlp8 );
        ...
        first_btn.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent( FirstWhlp8.this, First.class);
        ...
        back_arrow.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( FirstWhlp8.this, grade8.class);
                startActivity(intent);
                finish();
            }
        } );
