package com.activity.snhs.Whlp.whlp9;
...
import com.activity.snhs.Whlp.whlp9.first.Whlp9Second;

public class SecondWhlp9 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_second_whlp9 );
        ...
        first_btn.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent(SecondWhlp9.this, Whlp9Second.class);
        ...
        back_arrow.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( SecondWhlp9.this, grade9.class);
                startActivity(intent);
                finish();
            }
        } );
