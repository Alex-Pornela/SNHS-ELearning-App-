...
import com.activity.snhs.Whlp.whlp10.Quarter.First;


public class FirstWhlp10 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_first_whlp10 );
        ...
        first_btn.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                Intent intent = new Intent( FirstWhlp10.this, First.class);
        ...
        back_arrow.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( FirstWhlp10.this, grade10.class);
                startActivity(intent);
                finish();
            }
        } );
