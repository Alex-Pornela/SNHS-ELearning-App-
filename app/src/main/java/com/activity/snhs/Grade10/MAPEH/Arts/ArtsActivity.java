...
public class ArtsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_arts4 );
        ...
        back_arrow.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( ArtsActivity.this, MainActivity4.class);
        ...
        first_btn.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( ArtsActivity.this, Quarter1.class);
                startActivity(intent);
            }
        } );
        ...
        second_btn.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( ArtsActivity.this, Quarter2.class);
                startActivity(intent);
            }
        } );
        ...
        third_btn.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( ArtsActivity.this, Quarter3.class);
                startActivity(intent);
            }
        } );
        ...
        fourth_btn.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( ArtsActivity.this, Quarter4.class);
                startActivity(intent);
            }
        } );
        ...
        next_btn.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( ArtsActivity.this, PEActivity.class);
                startActivity(intent);
            }
        } );
    }
