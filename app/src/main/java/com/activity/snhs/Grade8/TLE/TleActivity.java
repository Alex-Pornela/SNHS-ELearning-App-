...
public class TleActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView( R.layout.activity_tle2 );
        ...
        back_arrow.setOnClickListener( new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent( TleActivity.this, MainActivity2.class);
        ...
        first_btn.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( TleActivity.this, Quarter1.class);
                startActivity(intent);
            }
        } );
        ...
        second_btn.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( TleActivity.this, Quarter2.class);
                startActivity(intent);
            }
        } );
        ...
        third_btn.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( TleActivity.this, Quarter3.class);
                startActivity(intent);
            }
        } );
        ...
        fourth_btn.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( TleActivity.this, Quarter4.class);
                startActivity(intent);
            }
        } );
        ...
        next_btn.setOnClickListener( new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent( TleActivity.this, ApActivity.class);
                startActivity(intent);
            }
        } );
    }
